...
class TransactionService(object):
	...
	def buy(self,sellPrice=None,buyPrice=None,previous_qunatity=None,amount=None):
	...
	def sell(self,sellPrice=None,buyPrice=None,previous_qunatity=None,amount=None):
		self.D=amount/previous_qunatity
		self.S=1-(amount/previous_qunatity)
